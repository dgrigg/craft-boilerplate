...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__modules_home__ = __webpack_require__(3);
...
var Main = function () {
  function Main() {
    ...
    this.classMapping = {
      home: __WEBPACK_IMPORTED_MODULE_1__modules_home__["a" /* default */]
    };
  }
  ...
  _createClass(Main, [{
    ...
    value: function createModules() {
      ...
      __WEBPACK_IMPORTED_MODULE_0_jquery___default()("[data-js-module]").each(function (index, element) {
        var modules = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(element).attr("data-js-module");
...
var Home = function Home(element) {
  ...
  var test = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('body');
};
